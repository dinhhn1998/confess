...
theTime.add({
	...
	update: function(percent) {
		...
		document.querySelector('.container .sup').innerHTML= "My heart rate now is " + (thePercent+899);
	}
});
theTime.add({
	targets: getHeart,
...
document.querySelector('.Description .modal-title').innerHTML = `<i class="far fa-comment-alt"></i>&nbsp;It's because`;
document.querySelector('.Description .modal-body').innerHTML = `I'm in love with someone<i class="fas fa-heart"></i> `;
